...
class Druid: Hero, CanUseSpecialAttack, CanHaveCritDamage {
    ...
    func useSpecialAttack(enemy: Enemy, critRate: Double) -> Bool {
        ...
        let attackName2:String = "Kraft der Natur"
        let attackName3:String = "Wolfsrudel"
        let attackName4:String = "Tornadosturm"
