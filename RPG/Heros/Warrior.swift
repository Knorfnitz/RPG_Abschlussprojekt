...
class Warrior: Hero, CanUseSpecialAttack, CanHaveCritDamage {
    ...
    func useSpecialAttack(enemy: Enemy, critRate: Double) -> Bool {
        ...
        let attackName1:String = "Schmetterschlag"
        let attackName2:String = "Schwertsturm"
        let attackName3:String = "Klinge der Vernichtung"
        let attackName4:String = "Berserker"
        
        //Schadenberechnungen:
        
        let damageAttack1: Int = str * 2 * lvl
        let damageAttack2: Int = (str + def) * 2 * lvl
        let damageAttack3: Int = (str + def) * 3 * lvl
        let damageAttack4: Int = (str + def) * 5 * lvl
    ...
    func useSpecialAttackForTerminal(enemy: Enemy, critRate: Double, target: Int) -> Bool {
        ...
        let damageAttack1: Int = str * 2 
        let damageAttack2: Int = (str + def) * 2
        let damageAttack3: Int = (str + def) * 3
        let damageAttack4: Int = (str + def) * 5
