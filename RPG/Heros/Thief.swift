...
class Thief: Hero, CanUseSpecialAttack, CanHaveCritDamage {
    ...
    func useSpecialAttack(enemy: Enemy, critRate: Double) -> Bool {
        ...
        let attackName1:String = "Schattenschlag"
        let attackName2:String = "Nachklinge"
        let attackName3:String = "Dolchtanz"
        let attackName4:String = "Meisterdieb"
        
        //Schadenberechnungen:
        
        let damageAttack1: Int = dex * 2 * lvl
        let damageAttack2: Int = (str + dex) * 2 * lvl
        let damageAttack3: Int = (str + dex) * 3 * lvl
        let damageAttack4: Int = (str + dex) * 5 * lvl
    ...
    func useSpecialAttackForTerminal(enemy: Enemy, critRate: Double, target: Int) -> Bool {
        ...
        let damageAttack1: Int = dex * 2
        let damageAttack2: Int = (str + dex) * 2
        let damageAttack3: Int = (str + dex) * 3
        let damageAttack4: Int = (str + dex) * 5
