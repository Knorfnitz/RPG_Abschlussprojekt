...
class Ranger: Hero, CanUseSpecialAttack, CanHaveCritDamage {
    ...
    func useSpecialAttack(enemy: Enemy, critRate: Double) -> Bool {
        ...
        let attackName2:String = "Pfeilhagel"
        let attackName3:String = "Rächer des Walden"
        let attackName4:String = "Todesschuss"
